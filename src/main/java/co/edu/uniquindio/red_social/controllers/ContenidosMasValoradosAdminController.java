...
public class ContenidosMasValoradosAdminController {
    ...
    @FXML
    private TableView<?> contenidosMasValoradosTable;
    ...
    @FXML
    private TableColumn<?, ?> numeroTableColumn1;
    ...
    @FXML
    private TableColumn<?, ?> tituloTableColumn;

    @FXML
    private TableColumn<?, ?> valoracionTableColumn;
